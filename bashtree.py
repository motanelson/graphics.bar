...
def parse_bashtree_tree(file_path):
...
def main():
    file_name = input("Enter the name of the .idx language file to load: ")

    try:
        tree = parse_bashtree_tree(file_name)
        print("\nParsed index language Tree:")
        print(tree)
